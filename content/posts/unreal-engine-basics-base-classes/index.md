...
date: 2021-02-14
slug: "unreal-engine-basics-base-classes"
...
[![Blueprint editor options](blueprint-editor.png)](blueprint-editor.png)
...
[![UMyObject instance received debug](my-object-cdo-ann.png)](my-object-cdo-ann.png)
...
[![UMyObject UClass on debug](debug-static-class-ann.png)](debug-static-class-ann.png)
...
[![Creating a blueprint](create-blueprint.png)](create-blueprint.png)
...
[![Deriving UMyObject](deriving-myobject.png)](deriving-myobject.png)
...
[![DerivedObject asset](derived-object.png)](derived-object.png)
...
[![DerivedObject blueprint editor](derived-object-editor-ann.png)](derived-object-editor-ann.png)
...
[![Received DerivedObject debug](derived-object-cdo.png)](derived-object-cdo.png)
...
[![BlueprintGeneratedClass expanded on debug](blueprint-gen-class.png)](blueprint-gen-class.png)
...
[![DerivedObject on blueprint editor with added members](edited-derived-object-bp.png)](edited-derived-object-bp.png)
...
[![BlueprintGeneratedClass expanded on debug](edited-derived-object-bp-debug.png)](edited-derived-object-bp-debug.png)
