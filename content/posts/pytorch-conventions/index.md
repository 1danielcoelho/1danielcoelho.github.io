...
[![Single linear layer](nn_layer.png)](nn_layer.png)
...
[![Weights and biases for a single linear layer](weights_and_biases.png)](weights_and_biases.png)
...
[![X and Y row vectors](xy.png)](xy.png)
...
[![Single linear layer matrix equation](linear_layer.png)](linear_layer.png)
